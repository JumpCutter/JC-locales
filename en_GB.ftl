...
compare-sections-tooltip = This refines the results. Each section is compared to its neighboring sections to determine whether or not data is an outlier. Every bit of data is relative since there is so much fluctuation in audience behaviour and retention. If you select 1 it will look at 1 section in both directions. If you select 5 it will look 5 sections in each direction. This determines how relative you want your edits to be. The default should be fine. Recommended: {$VODinitialCompareSection}
...
dependency-licenses-label = Dependency licences
...
license-type = {$pkgLicense} licence
dependency-project-homepage = Project homepage
dependency-full-license = Full licence
